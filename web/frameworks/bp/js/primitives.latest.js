/**
 * @preserve Basic Primitives orgDiagram v2.0.9
    ...
    */
	...
	if (parentTreeItem.visualChildren.length > 0) {
		...
		if (!hideConnectors && points.length > 0) {
		    connectorStyleType = this._drawTopConnectors(buffer, parentHorizontalCenter, parentTreeLevel.connectorShift, points, hasSquared);
		}
